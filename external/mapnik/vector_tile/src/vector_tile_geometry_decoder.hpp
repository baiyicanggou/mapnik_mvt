...
public:
  ...
  enum command : uint8_t { end = 0, move_to = 1, line_to = 2, close = 7 };
...
MAPNIK_VECTOR_INLINE mapnik::geometry::geometry<value_type>
decode_geometry(GeometryPBF &paths, std::int32_t geom_type, unsigned version,
                value_type tile_x, value_type tile_y, double scale_x,
                double scale_y, mapnik::box2d<double> const &bbox);
